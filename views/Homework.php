...
<html>
    ...
    <body>
        ...
        <table id="dg" title="Tareas" class="easyui-datagrid" style="width:100%;height:550px"
               url="../php/Homework/getHomework.php"
        ...
        <script type="text/javascript">
            ...
            function newUser() {
                ...
                $('#fm').form('clear');
                url = '../php/Homework/saveHomework.php';
            }
            function editUser() {
                ...
                if (row) {
                    ...
                    url = '../php/Homework/updateHomework.php?id=' + row.IdTarea;
                }
            }
            ...
            function startHomework() {
                ...
                if (row) {
                    $.messager.confirm('Confirm', 'Desea iniciar esta tarea?', function (r) {
                        if (r) {
                            $('#fm').form('load', row);
                            $.post('../php/Homework/startHomework.php', {id: row.IdTarea,nombre: row.Nombre,fechaestimado: row.FechaFinEstimadoTarea,idresponsable: row.IdResponsableTarea,FechaInicioTarea: row.FechaInicioTarea}, function (result) {
