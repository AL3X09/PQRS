...
<html>
    ...
    <body>
        <table id="dg" title="My Users" class="easyui-datagrid" style="width:700px;height:250px"
               url="../php/TypeDocument/getTypeDocument.php"
        ...
        <script type="text/javascript">
            ...
            function newUser() {
                ...
                $('#fm').form('clear');
                url = '../php/TypeDocument/saveTypeDocument.php';
            }
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = '../php/TypeDocument/updateTypeDocument.php?IdTipoDocumento=' + row.IdTipoDocumento;
                }
            }
            function saveUser() {
                $('#fm').form('submit', {
