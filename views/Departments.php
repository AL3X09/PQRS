    ...
    <body>
        <table id="dg" title="My Users" class="easyui-datagrid" style="width:700px;height:250px"
            ...
            <thead>
                <tr>
                    ...
                    <th field="CodigoDANE" width="50">Phone</th>
                    <th field="Activo" width="50">Email</th>
                </tr>
            </thead>
        </table>
        <div id="toolbar">
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
            ...
            <form id="fm" method="post" novalidate>
                ...
                <div class="fitem">
                    <label>Pais</label>
                    <input name="IdPais" class="easyui-combobox" data-options="url:'../php/Country/getCountry.php',textField:'Nombre',valueField:'IdPais'" required="true">
                </div>
                <div class="fitem">
                    <label>CodigoDANE</label>
