...
<html>
    ...
    <body>
        <table id="dg" title="My Users" class="easyui-datagrid" style="width:700px;height:250px"
               url="../php/State/getState.php"
               toolbar="#toolbar" pagination="true"
               rownumbers="true" fitColumns="true" singleSelect="true">
            <thead>
                <tr>
                    <th field="Nombre" width="50">Nombre</th>                    
                    <th field="valorRadicacion" width="50">Radicacion</th>                    
                    <th field="valorTipificacion" width="50">Tipificacion</th>                    
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
            ...
            <form id="fm" method="post" novalidate>
                ...
                <div class="fitem">
                    ...
                    <input name="Radicacion" class="easyui-switchbutton" required="true">
                </div>                
                <div class="fitem">
                    <label>Tipificacion</label>
                    <input name="Tipificacion" class="easyui-switchbutton" required="true">
                </div>                
                <div class="fitem">
                    <label>Estado</label>
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = '../php/State/updateState.php?IdEstado=' + row.IdEstado;
                }
            }
            function saveUser() {
                $('#fm').form('submit', {
